    ...
    <div className="form" >
       <form  onSubmit={handlesubmit}>
        <div className="row">
                ...
                <input type="text" name="owner" onChange={(e)=>setowner(e.target.value)} value={owner} />
                ...
                <input type="date" name="startdate" onChange={(e)=>setdate(e.target.value)} value={date} />
                ...
                <input type="number" name="pin" onChange={(e)=>setpin(e.target.value)} value={pin} />

                <label htmlFor="postoffice">Post Office:</label>
                <input type="text" name="postoffice"  onChange={(e)=>setpostoffice(e.target.value)} value={postoffice} />

                <label htmlFor="state">State:</label>
                <input type="text" name="state" onChange={(e)=>setmstate(e.target.value)} value={mstate} />
